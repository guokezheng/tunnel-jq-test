    ...
    protected void configure(HttpSecurity httpSecurity) throws Exception
    {
        httpSecurity
                ...
                .antMatchers("/login", "/register","/system/user/getToken", "/captchaImage", "/appLogin",
                        ...
                        "/robot/getWorkRobot","/event/addOutageEvent","/analysis/substation/devicesInfo","/devices/syncData","/event/upload","/parser/board/commonControlPhone","/event/wjEventUpdate"
                ).anonymous()
                .antMatchers(
                        HttpMethod.GET,
                        "/",

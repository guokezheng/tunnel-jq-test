...
import com.tunnel.business.mapper.dataInfo.SdEventDetectionMapper;
import com.tunnel.business.service.dataInfo.ISdEventDetectionService;
    ...
    public static String ioToBase64(String url) {
        ...
        if (url == null || "".equals(url)) {
            ...
            try {
                ...
                remoteAbsoluteFile = new String(remoteAbsoluteFile.getBytes(StandardCharsets.UTF_8), StandardCharsets.ISO_8859_1);
                // 获得输入流
                ...
                strBase64 = "data:image/jpg;base64," + Base64.getEncoder().encodeToString(bytes);
            } catch (Exception e) {
                e.printStackTrace();
            }
        }

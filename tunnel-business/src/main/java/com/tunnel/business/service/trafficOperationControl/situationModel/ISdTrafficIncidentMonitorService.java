package com.tunnel.business.service.trafficOperationControl.situationModel;
...
public interface ISdTrafficIncidentMonitorService {
     ...
     */
    SdTrafficIncidentMonitor selectSdTrafficIncidentMonitorByMonitorId(Long monitorId);
     ...
     */
    List<SdTrafficIncidentMonitor> selectSdTrafficIncidentMonitorList(SdTrafficIncidentMonitor sdTrafficIncidentMonitor);
     ...
     * @return 结果
     */
    int insertSdTrafficIncidentMonitor(SdTrafficIncidentMonitor sdTrafficIncidentMonitor);
     ...
     * @return 结果
     */
    int updateSdTrafficIncidentMonitor(SdTrafficIncidentMonitor sdTrafficIncidentMonitor);
     ...
     * @return 结果
     */
    int deleteSdTrafficIncidentMonitorByMonitorIds(Long[] monitorIds);
     ...
     * @return 结果
     */
    int deleteSdTrafficIncidentMonitorByMonitorId(Long monitorId);

...
public enum DeviceProtocolCodeEnum {
    ...
    XI_MEN_ZI_PLC_TCP_PROTOCOL_CODE("XI_MEN_ZI_PLC_TCP_PROTOCOL","西门子PLC TCP协议"),
    NEW_XI_MEN_ZI_PLC_TCP_PROTOCOL("NEW_XI_MEN_ZI_PLC_TCP_PROTOCOL","新西门子PLC协议（modbus4j）"),
    WZB_XI_MEN_ZI_PLC_TCP_PROTOCOL_CODE("WZB_XI_MEN_ZI_PLC_TCP_PROTOCOL","文祖北西门子PLC TCP协议");

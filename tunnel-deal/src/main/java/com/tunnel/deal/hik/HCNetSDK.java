...
//    HCNetSDK INSTANCE = (HCNetSDK) Native.loadLibrary("HCNetSDK",HCNetSDK.class);
    HCNetSDK INSTANCE = (HCNetSDK) Native.loadLibrary("D:\\TunnelPlatform-V3\\trunk\\tunnel-platform\\src\\main\\java\\com\\tunnel\\platform\\hkdevice\\storages\\HCNetSDK.dll",
        HCNetSDK.class);
...
//设备编码类型配置(NET_DVR_COMPRESSION_AUDIO结构)
    ...
    public static final int COMM_FIREDETECTION_ALARM = 0x4991; // 火点检测报警信息
    /*************操作异常类型(消息方式, 回调方式(保留))****************/
...
//校时结构参数
    ...
    public static class NET_DVR_FIREDETECTION_ALARM extends HIKSDKStructure {
        ...
        public byte[] byRes49 = new byte[49];
    }
    ...
    public static class NET_DVR_AID_INFO  extends HIKSDKStructure {
        ...
        public int dwAIDType;  // 报警事件类型（dwAIDTypeEx为0时取该参数，dwAIDTypeEx不为0时直接解析dwAIDTypeEx）
        public int dwAIDTypeEx;  // 报警事件类型扩展（兼容dwAIDType参数）
...
public static class NET_DVR_VILOST extends HIKSDKStructure {    //信号丢失报警(子结构)
 ...
 public static class NET_DVR_PICCFG extends HIKSDKStructure { //通道图象结构(SDK_V13及之前版本)
    ...
    public static class NET_DVR_COMPRESSIONCFG_EX extends HIKSDKStructure {//通道压缩参数(扩展)
	public int dwSize;
	public NET_DVR_COMPRESSION_INFO_EX struRecordPara; //录像
	public NET_DVR_COMPRESSION_INFO_EX struNetPara;	//网传
}

    public static class NET_DVR_RECCOMPRESSIONCFG_EX extends HIKSDKStructure {//录象时间段压缩参数配置(GE定制)2006-09-18
	int dwSize;
...
public static class RECV_ALARM extends HIKSDKStructure{
 ...
 /***API函数声明,详细说明见API手册***/
   public static interface FRealDataCallBack_V30 extends StdCallLibrary.StdCallCallback {
   ...
   public static interface FSerialDataCallBack extends StdCallLibrary.StdCallCallback {
    ...
    public static interface FColLocalDataCallBack extends StdCallLibrary.StdCallCallback {
     ...
     public static interface FColGlobalDataCallBack extends StdCallLibrary.StdCallCallback {
        public void invoke(NativeLong lUserID, String sIPAddr, NativeLong lColumnAmout, String pRecvDataBuffer,int dwBufSize,int dwUser);
      }

   public static interface FJpegdataCallBack extends StdCallLibrary.StdCallCallback {
    ...
    public static interface FPostMessageCallBack extends StdCallLibrary.StdCallCallback {
...
{
    PlayCtrl INSTANCE = (PlayCtrl) Native.loadLibrary("D:\\TunnelPlatform-V3\\trunk\\tunnel-platform\\src\\main\\java\\com\\tunnel\\platform\\hkdevice\\storages\\PlayCtrl.dll",
            PlayCtrl.class);

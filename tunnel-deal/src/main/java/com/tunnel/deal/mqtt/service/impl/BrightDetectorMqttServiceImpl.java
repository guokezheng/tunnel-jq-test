...
public class BrightDetectorMqttServiceImpl implements HongMengMqttService {
    ...
    public void handleReceiveData(String topic, SdDevices sdDevices, String payload) {
        ...
        if(topic.contains("rhy/iot/receive/brightDetector/execStatus/")){
            //指令执行情况上报
            handleExecStateReceiveData(sdDevices,payload,"rhy/iot/control/brightDetector/getBizAttr/");
        }
    }
...
//        }
        ...
        //修改设备实时状态
        sdDeviceDataService.updateDeviceData(sdDevices,brightness, (long) DevicesTypeItemEnum.LIANG_DU_OUTSIDE.getCode(),true);

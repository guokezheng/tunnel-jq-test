 ...
 * @date 2023/9/17
 */
@Component("XiMenZiPlcTask")
public class XiMenZiPlcTask {
    ...
    public void deviceInfoCache(){
        tcpClientGeneralService.deviceInfoCache(deviceMap, DeviceProtocolCodeEnum.XI_MEN_ZI_PLC_TCP_PROTOCOL_CODE.getCode(), DevicesTypeEnum.PLC.getCode());
    }

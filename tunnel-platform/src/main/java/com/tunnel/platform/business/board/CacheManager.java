...
public class CacheManager {
    ...
    //载入缓存信息
    public static void putCacheInfo(String key, ArrayList<String> obj, long dt, boolean expired) {
    ...
    //重写载入缓存信息方法
    public static void putCacheInfo(String key, ArrayList<String> obj, long dt){
    	Cache cache = new Cache();
        cache.setKey(key);

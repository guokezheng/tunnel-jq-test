...
//    @Async(value = "synchronousEnergyTaskExecutor")
    ...
    public void synchronousEnergyDataTask() throws ParseException {
        ...
        for (ExternalSystem eSystem : externalSystems) {
            String url = eSystem.getSystemUrl() + "login";
            Map<String, Object> map = new HashMap<String, Object>();
            map.put("username", eSystem.getUsername());
            map.put("password", eSystem.getPassword());
            String result = "";
            try {
            ...
            url = eSystem.getSystemUrl() + "analysis/getElectricityReportList";
            ...
            String tunnelId = "";
            String[] strArr = eSystem.getTunnel().split(",");
            // 拼接成字符串

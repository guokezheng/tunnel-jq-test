...
import com.tunnel.platform.mapper.dataInfo.SdDataTrafficHourMapper;
        ...
        for (int i = 0;i < data.size();i++) {
            ...
            if (byLaneStateName.equals("拥挤")) {
                ...
                if (i == 0) {
                    ...
                    String s = format.format((double) (stakeMark - start) / totel * 100);
                    left = s + "%";
                    map.put("left","0%");
                    map.put("width", left);
                } else {
                    ...
                    String s = format.format((double) (stakeMark - previous) / totel * 100);
                    left = s + "%";
                    map.put("width", left);
                    String s1 = format.format((double) (previous - start) / totel * 100);
                    previousPercent = s1 + "%";

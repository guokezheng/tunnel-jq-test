package com.tunnel.platform.utils.http;
...
//			httpConnection.setReadTimeout(3*1000);
	...
	public static void main(String[] args) {
		...
		String rw1 = URLConnection.processRequest("http://172.16.13.202:8080/QLJTIOTWebapp/issp/v1.0/login", "post", jsonObject);
		JSONObject parseObject = JSONObject.parseObject(rw1);
		String ttt = (String) parseObject.get("token");
		JSONObject json = new JSONObject();
		json.put("token", ttt);
		
		String rw31 = URLConnection.processRequest("http://172.16.13.202:8080/QLJTIOTWebapp/issp/v1.0/getCycleTrafficInfo", "get", null, json);

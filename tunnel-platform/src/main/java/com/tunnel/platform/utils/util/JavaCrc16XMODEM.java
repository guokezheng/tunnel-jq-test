...
public class JavaCrc16XMODEM {
     ...
     * @return
     */
    public static String getCrcCode(String code){
        byte[] b = StringUtil.hexString2Bytes(code);
        String crc = Integer.toHexString(JavaCrc16XMODEM.getCRC1021(b,b.length)).toUpperCase();
        return code + crc;
    }
    ...
    public static void main(String args[]) throws UnsupportedEncodingException {
        ...
        //String code = "30 30 31 30 70 6C 61 79 2E 6C 73 74 2B 00 00 00 00 5B 6C 69 73 74 5D 0D 0A 69 74 65 6D 5F 6E 6F 3D 31 0D 0A 69 74 65 6D 30 3D 35 30 30 2C 20 31 2C 20 30 2C 5C 66 73 33 32 33 32 5C 43 30 31 36 30 30 30 5C 63 32 35 35 32 35 35 30 30 30 30 30 30 BD F7 C9 F7 BC DD CA BB 20 20 B1 A3 B3 D6 B3 B5 BE E0 0D 0A";
        String code = "00 04 00 00 0B 00 04 02 00 19 00 D6 01 65 00 BC 01 55 00 70 00 00 07 D5 00 00 07 D6 00 00 00 00 06 01 0E".replace(" ","");
        //CD82
        byte[] b = StringUtil.hexStr2StrType(code.replace(" ","")).getBytes("GBK");

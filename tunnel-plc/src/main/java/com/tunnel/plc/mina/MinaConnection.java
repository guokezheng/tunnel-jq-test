...
import com.tunnel.plc.plcutil.DisPlayUtil;
...
public class MinaConnection implements IConnection {
    ...
    public MinaConnection(String id, String ip, int port) {
        ...
        this.ip = ip;
        this.port = port;
        this.commands = CmdUtil.getCmdMap().get(id).getCmdList();
        this.hostControlType = CmdUtil.getCmdMap().get(id).getHostControlType();
        this.handshake = DisPlayUtil.handshake();
        init();
    }

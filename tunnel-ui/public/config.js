const GlobalConfig = {
  jiqing: { //济青配置
    ...
    */
    eventTopics: [//交通事件配置
      ...
      { label: '其他', layerName: 'otherLayer', otherLayer: true, id: '99' },
    ...
    perceptionEvent: [ //感知事件配置
      ...
      { label: '抛撒物', layerName: 'throwGzLayer', throwGzLayer: true, id: '20' },
    ...
    roadTestEquipment: [//路侧设备配置
      ...
      { label: '摄像机', layerName: 'jqvideoLayer', jqvideoLayer: true, id: '003', roadIdKey: 'road_id', opmaManageIdKey: { 'opma_manag': 'opmaManagerCorpIds', 'opma_man_2': 'opmaManagerIds' }},
  ...
  danao: { //大脑配置 跟济青一样
    ...
    roadTestEquipmentShow: true,
    roadNetworkFacilitiesShow: true,
    ...
    maintenance: [
      ...
      { label: '应急车辆（安装定位设备）', layerName: 'patrolAccidentLayer', patrolAccidentLayer: true, id: '020',organizationSql:true },
	...
	trafficMonitorType: "TEST",//PROD 正式，TEST 测试

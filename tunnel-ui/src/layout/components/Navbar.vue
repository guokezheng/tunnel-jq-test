<template>
  <div class="navbar" :style="sideTheme == 'theme-light' || sideTheme == 'theme-dark'?'display:flex;':''">
    ...
    <div class="right-menu" >
      ...
      <!-- 预警 -->
      <el-tooltip  :content="alarmTitle" effect="dark" placement="bottom"  class="right-menu-item bell" style="display: inline-block;">
          <el-popover
              placement="bottom"
              trigger="click" @click="disabled = !disabled">
              <div style="height: 30px;">
                <span class="popover_hint" style="float: left;color: rgb(254, 0, 0);">预警({{nodealNum}}个待解决)</span>
                <span class="popover_hint" style="float: right; font-size: 14px;cursor: pointer;" @click="moreInfo">更多>></span>
                <span class="popover_hint" style="float: right;color: rgb(0, 170, 255);cursor: pointer; margin-right: 30px;" @click="ignores">全部忽略</span>

              </div>
              <div style="border: 0.4px solid rgb(204, 204, 204);"></div>
              <el-table :data="warningInfoList">
                  <el-table-column width="150" property="warningName" label="预警名称"></el-table-column>
                  <el-table-column width="180" property="warningTime" label="预警时间"></el-table-column>
                  <el-table-column width="150" property="tunnelName" label="隧道名称"></el-table-column>
                  <el-table-column width="300" property="inforSources" label="预警内容"></el-table-column>
                  <el-table-column width="100" property="processState" label="处理状态">
                    <template slot-scope="scope">
                      <el-tag v-if="scope.row.processState == 0" type="danger">未处理</el-tag>
                    </template>
                  </el-table-column>
              ...
              />
                <div :class="topNav && sideTheme == 'theme-dark'?'avatar-wrapper white_icon':'avatar-wrapper'" slot="reference">
                  <el-badge :value="nodealNum" :hidden="nodealNum > 0 ? false : true" class="item bell_icon"
      ...
      <el-dropdown class="right-menu-item bell">
        ...
        <el-tooltip content="监控一体化大屏" effect="dark" placement="bottom">
          <i class="el-icon-s-platform homefun right-menu-item hover-effect white_icon" @click="bigScreenfun" style="height: 33px;font-size: 20px;padding: 13px 0px" title="监控一体化大屏"></i>
        </el-tooltip>
      </el-dropdown>
      <!--  个人中心  -->
...
import { listWarning,listWarningInfo,getStrategyList,getDeviceInfo,handleStrategy,handleStrategyRollBack,emdeviceList,emergencyPerList,getTrafficInfo,getIgnoreEvent,oneKeyIgnore,ioToBase64} from "@/api/event/warningInfo";
...
.el-dropdown-menu_theme-light{
  ...
  .el-tabs__content{
    .theme-light .el-scrollbar__wrap{background-color:rgba(255,255,255,0.8);}
    .el-scrollbar__view{
      .warnItem{
        .description{
          p{color:#000000;}
          span,h5{color:#999999;}
        }
      }
    }
  }
...
<style>
  .bell_icon .el-badge__content{top: 13px !important;}
</style>

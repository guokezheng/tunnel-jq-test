          ...
          <template v-else>
            <div :class="{'fixed-header':fixedHeader}" :style="fixedHeader?'width:100%;':''">
              <div class="topNav_head">
                ...
                <navbar :class="sideTheme=='theme-light'?'theme-light-navbar':'theme-dark-navbar'" :style="weatherView?'width: 15%!important;justify-content:right;':'width: 25%;justify-content:right;'"/>
              </div>
            </div>
            <div :class="{hasTagsView:needTagsView}" class="main-container" :style="fixedHeader?'padding-top:50px;margin-left:0px;':'margin-left:0px;'">
              <breadcrumb :style="$route.path == '/index'?'display:none;':$route.path == '/map' ? 'display:none;':''" ref="Breadcrumb" id="breadcrumb-container" class="breadcrumb-container" style="margin-left:20px;" />
              <app-main />
              <right-panel>
                <settings />
              </right-panel>
...
<style lang="scss" scoped>
  ...
  .topNavHeadBlue{box-shadow:2px 0 6px rgb(0 21 41 / 35%);background-size: 100% 100%;width:100%;}
  ...
  .weather p{color:white;height:50px;line-height:50px;text-indent: 10px;white-space: nowrap;font-size: 14px;}
  .weather img{width:25px;height:25px;}
  .weather{display: flex;justify-content: center;align-items: center;width:11%;float:left;}

  ...
  <div>
    ...
    <div class="changeFunction" >
     <el-tabs type="border-card" :tab-position="tabPosition" v-model="changeFunction" @tab-click="handleClick">
       ...
       <el-tab-pane name="2">
           <span slot="label"><i class="el-icon-user"></i> 值班人员</span>
       </el-tab-pane>
       <el-tab-pane name="3" >
           <span slot="label"><i class="el-icon-document-copy"></i> 执行预案
           <i class="el-icon-caret-right" v-show="!showPlanTab" ></i>
           <i class="el-icon-caret-bottom" v-show="showPlanTab"></i>
           </span>
       </el-tab-pane>
     </el-tabs>
    </div>
    ...
    <div class="changeTunnel" v-show="showPlanTab">
        <el-tabs type="border-card" :tab-position="tabPosition" v-model="changeTunnel" @tab-click="handleClick2">
          <el-tab-pane name="1">
              <span slot="label"><i class="el-icon-data-analysis"></i> 隧道消防预案</span>
          </el-tab-pane>
          <el-tab-pane name="2">
              <span slot="label"><i class="el-icon-files"></i> 道路消防预案</span>
          </el-tab-pane>
          <el-tab-pane name="3">
              <span slot="label"><i class="el-icon-coin"></i> 其他预案</span>
          </el-tab-pane>
        </el-tabs>
    </div>
  </div>

...
export default {
  ...
  methods: {
    monthDaysCharts() {
      var monthDaysCharts = echarts.init(
        document.getElementById("monthDaysCharts")
      );
      var date = new Date().getMonth() + 1;
      var dateArr = [];
      var dateValArr = [
        1400, 1600, 1300, 1500, 1600, 1300, 1530, 1480, 1300, 1600, 1450, 1550,
      ];
    ...
    monthYearCharts() {
      var monthYearCharts = echarts.init(
        document.getElementById("monthYearCharts")
      );
      var date = new Date().getMonth() + 1;
      var option = {
        title: {
    ...
    monthRingCharts() {
      var monthRingCharts = echarts.init(
        document.getElementById("monthRingCharts")
      );
      var date = new Date().getMonth() + 1;
      var option = {
        title: {

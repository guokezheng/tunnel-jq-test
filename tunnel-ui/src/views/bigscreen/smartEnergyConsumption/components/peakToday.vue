...
export default {
  ...
  methods: {
    todayHoursCharts() {
      var todayHoursCharts = echarts.init(
        document.getElementById("todayHoursCharts")
      );
      var date = new Date().getHours();
      console.log(date, "date");
      var dateArr = [];
      var dateValArr = [
        38, 25, 38, 26, 30, 28, 30, 50, 79, 40, 38, 40, 60, 80, 70, 40, 50, 60,
        80, 70, 60, 50, 30, 20,
      ];
    ...
    todayYearCharts() {
      var todayYearCharts = echarts.init(
        document.getElementById("todayYearCharts")
      );
    ...
    todayRingCharts() {
      var todayRingCharts = echarts.init(
        document.getElementById("todayRingCharts")
      );
      var date = new Date().getDate();
      var option = {
        title: {

...
<script>
    ...
    export default{
        ...
        methods:{
            todayValueCharts() {
                var todayValueCharts = echarts.init(document.getElementById('todayValueCharts'));
                	...
                	var option = {
                      ...
                      formatter: function(params) {
                        ...
                        str += params[0].axisValue + '  峰值：  ' + params[0].value + '<br>'
            ...
            monthValueCharts(){
                var monthValueCharts = echarts.init(document.getElementById('monthValueCharts'))
                var option = {
                    title : {
                       show:true, 
                       text: '本月峰值对比1', 
            ...
            yearValueCharts(){
                var yearValueCharts = echarts.init(document.getElementById('yearValueCharts'))
                var option = {
                    title : {
                       show:true, 
                       text: '今年峰值对比', 

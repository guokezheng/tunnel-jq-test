...
// import { getChuEnergyTreeAPi,getNewEnergyTreeAPi } from '@/api/energyApi/index.js'
import node from 'vue-resource/src/http/client/node'
import departmentSelect from '@/views/components/department/chuDeptItem.vue'
...
export default {
  ...
  methods: {
    ...
    async getCircuitTree() {
      ...
      // await getNewEnergyTreeAPi({ deptCode: ids,sysType:'7'}).then(response => {

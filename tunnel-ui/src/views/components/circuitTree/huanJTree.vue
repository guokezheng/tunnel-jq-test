...
<script>
// import { getMonitoringTreeApi } from '@/api/energyApi/index.js'
import node from 'vue-resource/src/http/client/node'
import departmentSelect from '@/views/components/department/hjDeptSelect.vue'
...
export default {
  ...
  methods: {
    ...
    async getCircuitTree() {
      ...
      // await getMonitoringTreeApi({ deptCode: ids }).then(response => {

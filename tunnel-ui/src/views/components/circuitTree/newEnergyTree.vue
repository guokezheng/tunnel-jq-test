<template>
  <div>
    <el-tabs v-model="activeType" @tab-click="handleClick">
      <el-tab-pane label="光伏" name="6"></el-tab-pane>
      <el-tab-pane label="储能" name="7"></el-tab-pane>
    </el-tabs>
...
import departmentSelect from '@/views/components/department/gjEqument.vue'
...
export default {
  ...
  methods: {
    ...
    async getCircuitTree() {
      ...
      this.$emit('tab-btn', { sysType: this.activeType,label:this.selectIds })
      // const response = await getNewEnergyTreeAPi({ deptCode: ids, sysType: this.activeType })

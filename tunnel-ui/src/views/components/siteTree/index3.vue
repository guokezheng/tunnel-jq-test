  ...
  <div>
    ...
    <el-scrollbar>
      <el-row :style="{ height: height }">
        <el-tree class="tree" :data="siteTreeOptions" :props="defaultProps" :expand-on-click-node="false" :check-on-click-node="true" :show-checkbox="show_checkbox" :check-strictly="false" :filter-node-method="filterNode" ref="tree" default-expand-all @node-click="handleNodeClick" @check="handleCheckChange" node-key="code" highlight-current>
          <!-- 鼠标移入文本提示 -->

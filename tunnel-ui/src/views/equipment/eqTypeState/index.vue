          ...
          <el-row v-for="(item,index) in equipmentStates" :key="index">
            ...
            <el-col :span="4" >
              <el-form-item label="状态类型" prop="stateType" class="stateType">
                <el-select v-model="item.stateType" placeholder="请选择状态类型">
                  <el-option v-for="dict in isStateType" :key="dict.dictValue" :label="dict.dictLabel" :value="dict.dictValue"></el-option>
                </el-select>
              </el-form-item>
            </el-col>
            <el-col :span="4">

        ...
        <el-row>
          ...
          <el-col :span="21" v-if="showOrhide">
            <el-form-item label="查询指令" prop="controlPointAddress">
              <el-input
                v-model="form.controlPointAddress"
                placeholder="请输入查询指令"
              />
            </el-form-item>
          </el-col>
          ...
          <el-col :span="12" v-if="showOrhide">
            <el-form-item label="点位地址" prop="queryPointAddress">
              <el-input
                v-model="form.queryPointAddress"
                maxlength="50"
                placeholder="请输入点位地址"
              />
            </el-form-item>

  ...
  <div class="app-container">
        ...
        <el-row>
          ...
          <el-col :span="1" style="margin: 5px" v-if="submitMode == 1">
            <el-button
              ...
              size="mini"
              @click="automaticGenerationID(form)"
              >生成
            </el-button>
          </el-col>
          <el-col :span="12">
          ...
          <el-col :span="21" v-if="showOrhide">
            <el-form-item label="查询指令" prop="eqControlPointAddress">
              <el-input
                v-model="form.eqControlPointAddress"
                placeholder="请输入查询指令"
              />
            </el-form-item>
          </el-col>
          <el-col :span="1" style="margin: 5px" v-if="showOrhide">
            <el-button
              ...
              icon="el-icon-setting"
              size="mini"
              @click="createControlPointAddress"
              >生成
            </el-button>
          </el-col>
          <el-col :span="12" v-if="showOrhide">
            <el-form-item label="查询+机位" prop="instructionSeat">
              <el-input
                v-model="form.instructionSeat"
                placeholder="格式:DM_*/CIO_*"
              />
            </el-form-item>
          </el-col>
          <el-col :span="12" v-if="showOrhide">
          ...
          <el-col :span="12" v-if="showOrhide">
            <el-form-item label="点位地址1" prop="eqFeedbackAddress1">
              <el-input
                v-model="form.eqFeedbackAddress1"
                placeholder="请输入点位地址1"
              />
            </el-form-item>
          </el-col>
          ...
          <el-col :span="12" v-if="showOrhide">
            <el-form-item label="点位地址2" prop="eqFeedbackAddress2">
              <el-input
                v-model="form.eqFeedbackAddress2"
                placeholder="请输入点位地址2"
              />
            </el-form-item>
          </el-col>
          <el-col :span="12" v-if="showOrhide">
            <el-form-item label="点位地址3" prop="eqFeedbackAddress3">
              <el-input
                v-model="form.eqFeedbackAddress3"
                placeholder="请输入点位地址3"
              />
            </el-form-item>
          </el-col>
          <el-col :span="12" v-if="showOrhide">
            <el-form-item label="点位地址4" prop="eqFeedbackAddress4">
              <el-input
                v-model="form.eqFeedbackAddress4"
                placeholder="请输入点位地址4"
              />
            </el-form-item>
          </el-col>
          <el-col :span="12" v-if="showOrhide">
            <el-form-item label="点位地址5" prop="eqFeedbackAddress5">
              <el-input
                v-model="form.eqFeedbackAddress5"
                placeholder="请输入点位地址5"
              />
            </el-form-item>
          </el-col>
    ...
    >
      <el-row>
        <el-col
          :span="23"
          v-for="(item, index) in ctrlCommandList"
          :key="index"
          :index="index"
          style="margin: 10px"
        >
            ...
            <div style="padding: 14px">
              ...
              <div class="bottom clearfix">
                ...
                <el-button
                  ...
                  type="text"
                  class="button"
                  @click="updateCtrlCmd(item, index)"
                  >确认修改
                </el-button>
              </div>
            </div>
    ...
    >
        ...
        <el-row>
          <el-col :span="18">
            <el-form-item label="指令模式" prop="instruction">
              ...
              >
                <el-option
                  v-for="dict in instructionTypeOptions"
                  :key="dict.dictValue"
          ...
          <el-col :span="18">
            <el-form-item label="对应点" prop="qNumber">
              <el-input
                v-model="instructionForm.qNumber"
                placeholder="请输入对应点"
              />
            </el-form-item>
          </el-col>
      ...
      <div slot="footer" class="dialog-footer">
        <el-button
          type="primary"
          @click="insertEqControlPointAddress"
          v-hasPermi="['system:devices:createDmcontrolSeat']"
          >确 定</el-button
        >
...
export default {
  ...
  methods: {
    ...
    /** 下载模板操作 */
    importTemplate() {
      exportDevicesTemplate().then((response) => {
        this.$download.name(response.msg);
      });
    },

<template>
  <div class="app-container configurePage" v-loading="saveLoading" style="position: relative;"
    ...
    <el-dialog v-dialogDrag class="equipment-dialog" title="环境配置" :visible.sync="EnvironmentVisible" width="540px"
      append-to-body>
      <div class="dialog-content">
        <div v-for="items in EnvironmentList[Environmentflag]">
          <div class="equipment-img-box">
...
<script>
  ...
  export default {
    ...
    created: function() {
      ...
      img = [];
      let lane = this.getLanUrl(this.$route.query.tunnel.lane);
      this.selectedTunnel = {
        id: this.$route.query.tunnel.id,
        name: this.$route.query.tunnel.name,
        lane: lane,
      };

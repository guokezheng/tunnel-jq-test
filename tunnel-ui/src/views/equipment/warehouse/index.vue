    ...
    >
      ...
      >
        <template slot-scope="scope">
          <span>{{
            parseTime(scope.row.lastPurchaseTime, "{y}-{m}-{d}")
          }}</span>
        </template>
      </el-table-column>
      <el-table-column
        label="上次采购数量"
        align="center"
        prop="lastPurchaseQuantity"
      />
      <el-table-column
        label="上次采购单价"
        align="center"
        prop="lastPurchaseUnitPrice"
      />
      <el-table-column
        label="当前库存量"
        align="center"
    ...
    >
      ...
      <el-form ref="form" :model="form" :rules="rules" label-width="110px">
        ...
        <el-form-item label="上次采购数量" prop="lastPurchaseQuantity">
          <el-input
            v-model="form.lastPurchaseQuantity"
            maxlength="100"
            placeholder="请输入上次采购数量"
          />
        </el-form-item>
        <el-form-item label="上次采购单价" prop="lastPurchaseUnitPrice">
          <el-input
            v-model="form.lastPurchaseUnitPrice"
            maxlength="100"
            placeholder="请输入上次采购单价"
          />
        </el-form-item>

<template>
  <div>
    <el-form ref="timingControl" :model="strategyForm" :rules="formDataValidator" label-width="100px" height="700px">
      <el-row>
        <el-col :span="8">
          <el-form-item label="策略名称" prop="strategyName">
            <el-input style="width: 100%" v-model="strategyForm.strategyName" placeholder="请输入策略名称" />
          </el-form-item>
        </el-col>
        <el-col :span="8">
          <el-form-item label="隧道名称" prop="tunnelId">
            <el-select style="width: 100%" v-model="strategyForm.tunnelId" placeholder="请选择隧道" clearable
              @change="changeEvent()">
        ...
        <el-col :span="8">
          <el-form-item label="隧道方向" prop="direction">
            <el-select clearable v-model="strategyForm.direction" placeholder="请选择隧道方向" @change="changeEvent()"
              style="width: 100%">
              <el-option v-for="dict in directionOptions" :key="dict.value" :label="dict.dictLabel"
      ...
      <el-row>
        <el-col :span="14">
          <el-form-item label="执行日期" prop="execDate">
            <el-date-picker v-model="strategyForm.execDate" type="date" value-format="yyyy-MM-dd" placeholder="请选择日期"
              :picker-options="forbiddenTime" @change="changeTime" style="width: calc(100% - 155px);">
            </el-date-picker>
        ...
        <el-col :span="10">
          <el-form-item label="执行时间" prop="execTime">
            <el-time-picker v-model="strategyForm.execTime" placeholder="请选择时间" value-format="HH:mm:ss"
              @change="changeTime" style="width:100%">
            </el-time-picker>
          </el-form-item>
        </el-col>
      </el-row>
      ...
      <el-row :gutter="20" style="clear:both; height: 28vh;
        ...
        <el-col :span="24">
          <el-form-item v-for="(items, index) in strategyForm.autoControl" :key="index">
            ...
            <el-col :span="8">
              <el-select v-model="items.equipments" multiple collapse-tags placeholder="请选择设备"
                @change="qbgChange(index, items.equipments,false)" style="width:100%">
                <el-option v-for="item in items.equipmentData" :key="item.eqId" :label="item.eqName" :value="item.eqId"
            ...
            <el-col :span="8" v-show="items.equipmentTypeId == 16 || items.equipmentTypeId == 36">
              <!--              <el-cascader
                :props="checkStrictly"
                v-model="items.state"
              ...
              <el-input v-model="items.content" placeholder="请选择模板" readonly @click.native="openTemDialog(items)">
                <el-button slot="append" icon="el-icon-search"
                  @click.stop="templateClick(index, index,items)"></el-button>
              </el-input>
            </el-col>
            <el-col :span="8" v-show="items.equipmentTypeId == 7 ||  items.equipmentTypeId == 9">
              ...
              <el-input-number v-if="items.state == 1" v-model="items.stateNum" style="width: 53%;margin-left: 5px;"
                :min="items.limitMin" :max="100"></el-input-number>
            </el-col>
            <el-col :span="2" class="buttonBox">
              <el-button class="delete" @click="removeItem(index)"></el-button>
              <el-button class="add" @click="addItem"></el-button>
            </el-col>
          </el-form-item>
        </el-col>
      </el-row>
    ...
    <el-dialog :title="templateData.processName" :visible.sync="dialogVisibleTem" append-to-body width="45%"

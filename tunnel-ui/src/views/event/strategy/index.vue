...
import { listType,listHasType } from "@/api/equipment/type/api";
...
/*      scheduleForm:{
  ...
  methods: {
    ...
    handleSelectionChange(selection) {
      ...
      this.rlIds = selection.map(item => item.rlId)
    ...
    handleDelete(row) {
      ...
      const rlIds = row.rlId || this.rlIds;

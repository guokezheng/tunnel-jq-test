<template>
  <div class="container infoBoardBox" style="height: 100%">
        ...
        <el-form ref="form" :model="form">
          ...
          <el-form-item>
            <el-collapse v-model="iotBoardActive" accordion @change="handleChange">
              <el-collapse-item v-for="(item, index) in iotBoardList" :key="index" :title="item.label"
                :name="item.devicePixel">
                <div>
                  <el-checkbox style="width: 100%" :indeterminate="isIndeterminate" v-model="checkAll"
                  ...
                  <el-checkbox-group class="checkbox" v-model="checkedCities" @change="handleCheckedCitiesChange">
                    <el-checkbox v-for="(itm, index) in item.list" :label="itm.deviceId" :key="index">
                      ...
                      <el-tooltip content="回读当前信息" placement="top">
                        <el-button class="el-icon-tickets huiduButton" @click.stop.prevent="onSubmit(itm.deviceId)"
      ...
      <div style="width: 37.8%" class="verticalBox verticalBoxBorderLeft">
        <div class="bigTitle">
          ...
          <div class="controlBox">
            <el-button type="primary" @click.native="openDialogVisible(1, 2)"
              :disabled="form.devicePixel ? false : disabledButton">添加信息</el-button>
      ...
      <el-row>
        <el-col :span="18">
          <el-select v-model="toRightCategory" placeholder="请选择所属类别">
            <el-option v-for="item in iotTemplateCategoryList" :key="item.dictValue" :label="item.dictLabel"
    ...
    <editInfo :boardEmitItem="this.boardEmitItem" @receiveForm="receiveForm" v-if="this.showEmit"
      @dialogClose="dialogClose"></editInfo>
  </div>
</template>
<script>

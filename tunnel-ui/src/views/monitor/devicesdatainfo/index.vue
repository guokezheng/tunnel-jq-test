<template>
  <div class="app-container">
    <el-row :gutter="20" class="topFormRow">
      <el-col :span="6">
        <el-button size="small" :loading="exportLoading" @click="handleExportTab">导出
        </el-button>
        <el-button size="small" @click="resetQueryTab">刷新</el-button>
      </el-col>
      <el-col :span="6" :offset="12">
        <div ref="main" class="grid-content bg-purple">
          <el-input placeholder="请输入设备名称、桩号，回车搜索" v-model="querysParamsTab.pile" @keyup.enter.native="handleQueryTab">
            <el-button slot="append" class="searchTable" @click="device_boxShow = !device_boxShow"></el-button>
          </el-input>
        </div>
      </el-col>
    </el-row>
    <div class="searchBox" v-show="device_boxShow">
      <el-form ref="queryFormTab" :inline="true" :model="querysParamsTab" label-width="75px">
        <el-form-item label="所属隧道" prop="tunnelId" v-show="manageStatin == '0'">
          <el-select v-model="querysParamsTab.tunnelId" placeholder="请选择所属隧道" clearable size="small">
        ...
        <el-form-item label="设备类型" prop="searchValue">
          <el-select v-model="querysParamsTab.searchValue" placeholder="请选择设备类型" clearable size="small">
        ...
        <el-form-item class="bottomBox">
          <el-button size="small" type="primary" @click="handleQueryTab">搜索</el-button>
          <el-button size="small" @click="resetQueryTab" type="primary" plain>重置</el-button>
        </el-form-item>
      </el-form>
    </div>
    ...
    <el-table ref="tableFile" v-loading="loading" :data="listTab" @selection-change="handleSelectionChangeTab"
      @row-click="handleRowClick" class="allTable" :row-key="getRowKey1" height="62vh">
      ...
      <el-table-column label="操作" align="center" class-name="small-padding fixed-width">
        <template slot-scope="scope">
          <el-button size="mini" class="tableBlueButtton" @click="handleRecordy(scope.row)">查看详情</el-button>
        </template>
      </el-table-column>
    </el-table>

    <pagination v-show="totalTab > 0" :total="totalTab" :page.sync="querysParamsTab.pageNum"
      :limit.sync="querysParamsTab.pageSize" @pagination="getListTab" />

    <!--详情弹窗-->
    <el-dialog :visible.sync="record" width="70%" :before-close="cancel" :close-on-click-modal="false">
      ...
      <div>
        <el-row :gutter="20" class="topFormRow">
          <el-col :span="6">
            <el-button size="small" :loading="exportLoading" @click="handleExportRecord">导出
            </el-button>
          ...
          <el-col :span="1" :offset="13" style="margin-left: 45.166667%">
            <div @click="marketChang()">
              <i class="el-icon-s-marketing" style="font-size: 36px; color: #39adff; float: left"></i>
            </div>
          </el-col>
          <el-col :span="6" style="padding-left: 0px">
            <div style="width: 100%; float: left" id="pldiv">
              <el-form ref="querysForm" :inline="true" :model="querysParams" label-width="75px">
                <el-date-picker v-model="dateRange" size="small" style="width: 100%" value-format="yyyy-MM-dd HH:mm:ss"
                  type="datetimerange" range-separator="-" start-placeholder="开始日期" end-placeholder="结束日期"
                  @change="selectTime" :default-time="['00:00:00', '23:59:59']" append-to-body popper-class="DataStyle"
                  :picker-options="setDateRange"></el-date-picker>
              </el-form>
            </div>
          </el-col>
        </el-row>
      ...
      <div v-show="echartShow == false">
        <el-table ref="tables" v-loading="loading" :data="list" @selection-change="handleSelectionChange1"
          v-show="searchValue == '1'" class="allTable" height="58vh" :row-key="getRowKey">
        ...
        <el-table v-loading="loading" :data="list1" class="allTable" @selection-change="handleSelectionChange2"
          v-show="searchValue == '2'" height="58vh">
          <el-table-column type="selection" width="55" align="center" />
          ...
          <el-table-column label="采集时间" align="center" prop="createTime" width="180" sortable>
            <template slot-scope="scope">
              <span>{{ parseTime(scope.row.createTime) }}</span>
            </template>
          </el-table-column>
        </el-table>
        <el-table ref="tables" v-loading="loading" :data="list2" @selection-change="handleSelectionChange3"
          v-show="searchValue == '3'" class="allTable" height="58vh" :row-key="getRowKey">
          <el-table-column type="selection" width="55" align="center" />
        ...
        <el-table ref="tables" v-loading="loading" :data="list3" @selection-change="handleSelectionChange4"
          v-show="searchValue == '4'" class="allTable" height="58vh" :row-key="getRowKey">
          <el-table-column type="selection" width="55" align="center" />
        ...
        <!--        微波车检-->
        <el-table ref="tables" v-loading="loading" :data="list8" @selection-change="handleSelectionChange4"
          v-show="searchValue == '8'" class="allTable" height="58vh" :row-key="getRowKey">
          <el-table-column type="selection" width="55" align="center" />
          <el-table-column type="index" :index="indexMethod8" label="序号" width="68" align="center"></el-table-column>
          <!-- <el-table-column label="设备编码" align="center" prop="eqId" /> -->
          <el-table-column label="设备名称" align="center" prop="eqName" />
          <el-table-column label="所属隧道" align="center" prop="tunnelName" />
          <el-table-column label="管理机构" align="center" prop="deptName" />
        ...
        <!--  温湿度传感器-->
        <el-table ref="tables" v-loading="loading" :data="list7" @selection-change="handleSelectionChange4"
          v-show="searchValue == '7'" class="allTable" height="58vh" :row-key="getRowKey">
          <el-table-column type="selection" width="55" align="center" />
          <el-table-column type="index" :index="indexMethod7" label="序号" width="68" align="center"></el-table-column>
          <!-- <el-table-column label="设备编码" align="center" prop="eqId" /> -->
          <el-table-column label="设备名称" align="center" prop="eqName" />
          <el-table-column label="所属隧道" align="center" prop="tunnelName" />
          <el-table-column label="管理机构" align="center" prop="deptName" />
        ...
        <!--  水浸传感器-->
        <el-table ref="tables" v-loading="loading" :data="list6" @selection-change="handleSelectionChange4"
          v-show="searchValue == '6'" class="allTable" height="58vh" :row-key="getRowKey">
          <el-table-column type="selection" width="55" align="center" />
          <el-table-column type="index" :index="indexMethod6" label="序号" width="68" align="center"></el-table-column>
          <!-- <el-table-column label="设备编码" align="center" prop="eqId" /> -->
          <el-table-column label="设备名称" align="center" prop="eqName" />
          <el-table-column label="所属隧道" align="center" prop="tunnelName" />
          <el-table-column label="管理机构" align="center" prop="deptName" />
        ...
        <div style="height: 33px;">
          <pagination v-show="total > 0 && this.searchValue == '1'" :total="total" :page.sync="queryParams.pageNum"
            :limit.sync="queryParams.pageSize" @pagination="getList" />
          <pagination v-show="total > 0 && this.searchValue == '2'" :total="total" :page.sync="queryParams1.pageNum"
            :limit.sync="queryParams1.pageSize" @pagination="getList" />
          <pagination v-show="total > 0 && this.searchValue == '3'" :total="total" :page.sync="queryParams2.pageNum"
            :limit.sync="queryParams2.pageSize" @pagination="getList" />
          <pagination v-show="total > 0 && this.searchValue == '4'" :total="total" :page.sync="queryParams3.pageNum"
            :limit.sync="queryParams3.pageSize" @pagination="getList" />
          <pagination v-show="total > 0 && this.searchValue == '5'" :total="total" :page.sync="queryParams5.pageNum"
            :limit.sync="queryParams5.pageSize" @pagination="getList" />
          <pagination v-show="total > 0 && this.searchValue == '6'" :total="total" :page.sync="queryParams6.pageNum"
            :limit.sync="queryParams6.pageSize" @pagination="getList" />
          <pagination v-show="total > 0 && this.searchValue == '7'" :total="total" :page.sync="queryParams7.pageNum"
            :limit.sync="queryParams7.pageSize" @pagination="getList" />
          <pagination v-show="total > 0 && this.searchValue == '8'" :total="total" :page.sync="queryParams8.pageNum"
            :limit.sync="queryParams8.pageSize" @pagination="getList" />
        </div>

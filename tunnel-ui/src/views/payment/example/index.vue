      ...
      <div style="width: 100%;">
        ...
        <el-row :gutter="24" style="background-color: rgb(255, 242, 224);border-radius: 4px;">
          <div style="color: rgb(68, 181, 73);">
            <p style="padding-left: 3vw;">统一支付模块集成微信和支付宝SDK，支持微信、支付宝的服务商和普通商户模式下单，该页面提供支付体验流程。</p>
          </div>
        </el-row>
        <!--微信支付-->
        ...
        <el-row :gutter="24" style="margin-top: 2vh;">
          <el-card class="box-card" :body-style="{ height: '20vh'}">
            ...
            <el-button @click="immediatelyPay"
                       style="float: right;margin: 0 1vw 2vh 0;padding:5px 20px;background-color: #1953ff;border-radius: 5px;color:#fff"
                       type="primary">立即支付
            </el-button>
          </el-card>

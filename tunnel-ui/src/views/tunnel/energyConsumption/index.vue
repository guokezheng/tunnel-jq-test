  ...
  <div class="app-container">
    <div style="margin-bottom: 20px">
      ...
      <el-button-group
        ...
        v-for="(item, index) in tunnelData"
      >
        <el-button
          type="info"
          size="small"
  ...
  methods: {
    ...
    getTime() {
      ...
      if (this.tunnelName == "体育中心") {
        electricTodayArr = [
          40, 50, 55, 40, 37, 48, 58, 69, 83, 90, 86, 67, 54, 53, 42, 51, 54,
          59, 69, 74, 65, 56, 48, 42,
        ];
        electricMonth = [
          1300, 1400, 1500, 1450, 1550, 1600, 1540, 1480, 1380, 1330, 1450,
          1560, 1480, 1550, 1580, 1490, 1600, 1530, 1480, 1460, 1520, 1450,
          1480, 1520, 1560, 1580, 1480, 1520, 1540, 1600, 1540,
        ];
      } else {
        electricTodayArr = [
          90, 86, 67, 54, 53, 42, 40, 50, 55, 42, 51, 54, 59, 69, 74, 65, 56,
          48, 40, 37, 48, 58, 69, 83,
        ];
        electricMonth = [
          1580, 1490, 1600, 1530, 1550, 1600, 1500, 1450, 1560, 1580, 1480,
          1520, 1540, 1600, 1540, 1540, 1480, 1380, 1330, 1450, 1560, 1480,
          1550, 1520, 1480, 1460, 1520, 1450, 1480, 1300, 1400,
        ];
      }
    ...
    // 今日用电排行
    electricTodayCharts() {
      this.electricToday = echarts.init(
        document.getElementById("electricToday")
      );
      ...
      var option = {
        tooltip: {
          ...
          formatter: function (params) {
            var str =
              '<span style="display:inline-block;margin-right:5px;border-radius:10px;width:10px;height:10px;background-color:#fff000"></span>' +
              name +
              "<br>";
    ...
    // 本月用电排行
    electricMonthCharts() {
      this.electricMonth = echarts.init(
        document.getElementById("electricMonth")
      );
    ...
    electricRankingCharta() {
      ...
      var electricRanking = echarts.init(
        document.getElementById("electricRanking")
      );
      var option = {
    ...
    energyRankingCharts() {
      ...
      var energyRanking = echarts.init(
        document.getElementById("energyRanking")
      );
      var option = {
        // backgroundColor: '#010d3a',
        //提示框
    ...
    // 能耗占比
    alarmsCharts() {
      var proportionCharts = echarts.init(

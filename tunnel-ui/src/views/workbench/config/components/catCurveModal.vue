<template>
  <el-dialog class="timedControl" custom-class="no-scroll" title="车辆曲线图" :close-on-click-modal="false"
          ...
          <el-row :gutter="20" style="clear: both">
            ...
            <el-col :span="9">
              <el-form-item label="隧道名称" prop="tunnelId" class="el-form-item-data">
                <el-select style="width: 100%" :disabled="tunnelDisabled" v-model="catFilesModel.tunnelId"
                  placeholder="请选择隧道" clearable @change="catChangeEvent">
      ...
      <el-col :span="11">
        ...
        <el-form ref="loginQueryForm" :model="catFilesModelWei" :inline="true" class="loginQueryFormClass"
          ...
          <el-row :gutter="24" style="clear: both">
            ...
            <el-col :span="9">
              <el-form-item label="隧道名称" prop="tunnelId" class="el-form-item-data">
                <el-select style="width: 100%" :disabled="tunnelDisabled" v-model="catFilesModelWei.tunnelId"
                  placeholder="请选择隧道" clearable @change="catChangeEventWei">
                  <el-option v-for="item in tunnelData" :key="item.tunnelId" :label="item.tunnelName"
                    :value="item.tunnelId" />
                </el-select>
              </el-form-item>

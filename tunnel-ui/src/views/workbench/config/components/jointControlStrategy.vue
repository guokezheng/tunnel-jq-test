    ...
    <div class="bottomBox">
      ...
      <div class="content">
        <div class="handControl-container">
            ...
            >
              ...
              <el-row :gutter="24">
                ...
                <el-col
                  :span="20"
                  class="elcolNameOne"
                  v-html="'含控制指令' + item.slist.length + '条'"
                >
                </el-col>
              </el-row>
              <!--            <el-row :gutter="24">-->
          ...
          >
            <div
              v-for="item in lightStrategyList"
              :key="item.id"
              class="content-centre-one"
            >
              ...
              <el-row :gutter="24">
                ...
                <el-col
                  :span="20"
                  class="elcolNameOne"
                  v-html="'含控制指令' + item.instructNum + ' 条'"
                >
                </el-col>
              </el-row>
              <el-row :gutter="24">
          ...
          >
            <div
              v-for="item in catStrategyList"
              :key="item.id"
              class="content-centre-tree"
            >
              <!--              <span class="diagonal-text-no" v-if="item.isStatus==1">未生效</span>-->
              <!--              <span class="diagonal-text-yes"  v-if="item.isStatus==0">已生效</span>-->
              <el-row :gutter="24">

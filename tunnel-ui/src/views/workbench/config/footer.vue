    ...
    <div class="fourBox">
      <div class="footMiniBox" v-show="footChangeRadio == '图表'">
        <div class="footTitle">
          <div class="footTitleCont">
            <img :src="carIcon" style="width: 0.9vw; margin-right: 5px" v-show="sideTheme != 'theme-light'" />
            <p>车辆监测</p>
      ...
      <div class="footMiniBox footerRight" v-show="footChangeRadio == '图表'">
        <div class="footTitle">
          ...
          <div class="footTitleCont">
            <img :src="energyIcon" style="width: 1vw; margin-right: 5px" v-show="sideTheme != 'theme-light'" />
            <p>能耗监测</p>
      ...
      <div class="footMiniBox footerRight" v-show="footChangeRadio == '图表'">
        <div class="footTitle">
          <div class="footTitleCont">
            <img :src="keyVehiclesIcon" style="width: 0.8vw; margin-right: 5px" v-show="sideTheme != 'theme-light'" />
            <p>洞内外速度监测</p>
            <p>Opening speed</p>
          </div>
        </div>
      ...
      <div class="footerRight footMiniBox" v-show="footChangeRadio == '图表'">
        <div class="footTitle">
          <div class="footTitleCont">
            <img :src="warningIcon" style="width: 0.8vw; margin-right: 5px" v-show="sideTheme != 'theme-light'" />
            <p>预警事件</p>
            <p>Alert event</p>
          </div>
        </div>
        <div v-if="trafficList.length == 0" style="
            width: 100%;
            text-align: center;
            font-size: 14px;
            margin-top: 80px;
        ...
        <div class="jumpBox" v-if="trafficList">
          <div class="table_body">
            <el-row v-for="(item, index) of trafficList" :key="index" style="cursor: pointer"
              :style="{ top: tableTop + 'px' }" class="table_list" :data-index="JSON.stringify(item)" :id="item.id">
              <el-col :span="2">
                <div style="
                    width: 30px;
                    height: 30px;
      ...
      <div class="footMiniBox" v-show="footChangeRadio == '视频'" :style="{
          width:
            tunnelId == 'JQ-JiNan-WenZuBei-MJY' ? '19.5%' : '24.5% !important',
        }">
        <div class="footTitle">
          <div class="footTitleCont">
            <img :src="warningIcon" style="width: 16px; margin-right: 5px" v-show="sideTheme != 'theme-light'" />
            <p>{{ videoTitle1 }}</p>
            <p>real-time video</p>
          </div>
        </div>
        <videoPlayer v-if="liveUrl1 && tunnelId != 'WLJD-JiNan-YanJiuYuan-FHS'" :rtsp="liveUrl1" :open="cameraPlayer1">
        </videoPlayer>
        <video v-if="tunnelId == 'WLJD-JiNan-YanJiuYuan-FHS' && !videoNoPic1" id="h5sVideo2" class="h5video_" controls
          muted loop disablePictureInPicture="true"
          style="width: 100%; height: 200px; object-fit: cover; z-index: -100"></video>
        <div class="noPicBox" v-show="videoNoPic1">
          <img src="../../../assets/image/noVideo.png" />
        </div>
      </div>
      <div class="footMiniBox footerRight" v-show="footChangeRadio == '视频'" :style="{
          width:
            tunnelId == 'JQ-JiNan-WenZuBei-MJY' ? '19.5%' : '24.5% !important',
        }">
        <div class="footTitle">
        ...
        <videoPlayer v-if="liveUrl2 && tunnelId != 'WLJD-JiNan-YanJiuYuan-FHS'" :rtsp="liveUrl2" :open="cameraPlayer2">
        </videoPlayer>
        <video v-if="tunnelId == 'WLJD-JiNan-YanJiuYuan-FHS' && !videoNoPic1" id="h5sVideo3" class="h5video_" controls
          muted loop autoplay webkit-playsinline playsinline disablePictureInPicture="true"
      ...
      <div class="footMiniBox footerRight" v-show="
        ...
        <videoPlayer v-if="liveUrl5" :rtsp="liveUrl5" :open="cameraPlayer5"></videoPlayer>
      ...
      <div class="footMiniBox footerRight" v-show="footChangeRadio == '视频'" :style="{
        ...
        <videoPlayer v-if="liveUrl3 && tunnelId != 'WLJD-JiNan-YanJiuYuan-FHS'" :rtsp="liveUrl3" :open="cameraPlayer3">
        </videoPlayer>
        <video v-if="tunnelId == 'WLJD-JiNan-YanJiuYuan-FHS' && !videoNoPic2" id="h5sVideo4" class="h5video_" controls
          muted loop autoplay webkit-playsinline playsinline disablePictureInPicture="true"
          controlslist="nodownload noplaybackrate noremoteplayback"
          style="width: 100%; height: 200px; object-fit: cover; z-index: -100"></video>
      ...
      <div class="footMiniBox footerRight" v-show="footChangeRadio == '视频'" :style="{
        ...
        <videoPlayer v-if="liveUrl4 && tunnelId != 'WLJD-JiNan-YanJiuYuan-FHS'" :rtsp="liveUrl4" :open="cameraPlayer4">
        </videoPlayer>
        <video v-if="tunnelId == 'WLJD-JiNan-YanJiuYuan-FHS' && !videoNoPic2" id="h5sVideo5" class="h5video_" loop
          controls muted autoplay webkit-playsinline playsinline disablePictureInPicture="true"
          controlslist="nodownload noplaybackrate noremoteplayback"
          style="width: 100%; height: 200px; object-fit: cover; z-index: -100"></video>
        <div class="noPicBox" v-show="videoNoPic2">
          <img src="../../../assets/image/noVideo.png" />
...
<script>
  ...
  export default {
    ...
    methods: {
      ...
      initVehicleMonitoring(yData1,yData2) {
        let newPromise = new Promise((resolve) => {
          resolve();
        });
        //然后异步执行echarts的初始化函数
        newPromise.then(() => {
          ...
          let option = {
            ...
            tooltip: {
              ...
              formatter: function (param) {
                var tooltip = "<div style='display:flex;align-items:center;height:26px'>";
                tooltip += "<div style='width:10px;height:10px;border-radius:5px;background:#31CEFF;margin-right:4px'></div>";
                tooltip += param[4].name + param[4].seriesName + ": " + param[4].value + '辆<br>';
                tooltip += "</div><div style='display:flex;align-items:center;height:26px'>"
                tooltip += "<div style='width:10px;height:10px;border-radius:5px;background:#7BE748;margin-right:4px'></div>";
                tooltip += param[5].name + param[5].seriesName + ": " + param[5].value + "辆";
                tooltip += "</div>"
                return tooltip
              }
            },

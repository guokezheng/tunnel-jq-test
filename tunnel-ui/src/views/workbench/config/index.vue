<template>
  <div class="app-container">
    ...
    >
      ...
      <div class="siblings">
        ...
        >
          <div class="bingZhou">
            <span>济南方向：</span>
            <div class="number" :class="checked ? 'drawerActive' : 'drawerNo'">
              1
            </div>
    ...
    <com-video
      class="comClass"
      v-if="
        this.eqInfo.clickEqType == 23 ||
        this.eqInfo.clickEqType == 24 ||
        this.eqInfo.clickEqType == 25
      "
  ...
  created: function () {
    bus.$on("process", (e) => {
      ...
      if (e == "theme-light") {
        ...
        (this.echartsColor = "#0a88bd"), this.initeChartsEnd();
        this.initEnergyConsumption();
        this.loadFocusCar();
      }
    });

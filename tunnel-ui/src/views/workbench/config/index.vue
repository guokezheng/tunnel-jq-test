                ...
                > -->
                  ...
                  <div
                    ...
                    ><el-tooltip disabled :title="data.vehicleLicense"   placement="bottom" effect="light">
                      <span   class="my-div"  :title="data.vehicleLicense"  :style="{color: data.background}" @click="pCatClick(data.vehicleLicense)"> {{ data.vehicleLicense }}</span>
                      </el-tooltip>
                    </div>
                  </div>
                  <!-- 设备图标-->
    ...
    >
      ...
      <div slot="footer">
        <el-button
          type="primary"
          size="mini"
          @click="accidentDialogVisible = !accidentDialogVisible"
          >关 闭</el-button
        >
      </div>
    </el-dialog> -->

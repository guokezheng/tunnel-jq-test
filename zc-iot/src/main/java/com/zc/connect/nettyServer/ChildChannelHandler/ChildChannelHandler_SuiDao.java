package com.zc.connect.nettyServer.ChildChannelHandler;
...
/**
 * @auther YangChao
 * @description 隧道解析handler
 * @date 2021/11/18/018
 * @apiNote
 */
public class ChildChannelHandler_SuiDao extends ChannelInitializer<SocketChannel> {
    private static final Logger log = LoggerFactory.getLogger(ChildChannelHandler_SuiDao.class);

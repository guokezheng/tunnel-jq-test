 ...
 */
@Component
public class WebSocketStreamCatListener implements StreamListener<String, ObjectRecord<String, String>>
{
    private static final Logger log = LoggerFactory.getLogger(WebSocketStreamCatListener.class);
    ...
    public void onMessage(ObjectRecord<String, String> message) {
        ...
        String key = RedisStreamConstants.WebSocketCatDirectional.KEY;
        String group = RedisStreamConstants.WebSocketCatDirectional.GROUP;
